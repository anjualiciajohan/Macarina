              ...
              <table>
                ...
                <table border="0">
                    ...
                    <tr>
                        <td>No KTP</td>
                        <td>:</td>
                        <td><input disabled type="text" name="txt_no_ktp" value="<?php echo $data['no_ktp'] ?>"></td>
                    </tr>
                    <tr>
                        <td>Nama</td>
                        <td>:</td>
                    ...
                    <tr>
                        <td>Alamat </td>
                        <td>:</td>
                        <td><input disabled type="textarea" name="txt_almt" value="<?php echo $data['alamat'] ?>"> </td>
                    </tr>
                    <tr>
                        <td>No Telepon </td>
                        <td>:</td>
                        <td><input disabled type="textarea" name="txt_no" value="<?php echo $data['no_tlp'] ?>"> </td>
                    </tr>
                    <tr>
                        <td>Scan KTP </td>
                        <td>:</td>
                        <td><?php echo "<img src='../img/reseller/".$data['scan_ktp']."' width='200px' height='100px'/>" ?></td>
                    </tr>
                    <tr>
                        <td>Email</td>
                        <td>:</td>
                        <td><input disabled type="text" name="txt_email" value="<?php echo $data['email'] ?>" ></td>
                    </tr>
                    <tr>
                        <td>Password</td>
                        <td>:</td>
