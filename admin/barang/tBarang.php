              ...
              <form method ="POST" action="detAdmin.php" >
                ...
                <tbody>
                    <tr>
                      ...
                      <td><a class="edit" href="detBarang.php?txt_idbrg=<?php echo $data['kd_barang']; ?>">Edit</a>
                      <a class="edit" href="delBarang.php?txt_idbrg=<?php echo $data['kd_barang']; ?>">Hapus</a>
                      <a class="detail" href="detailBarang.php?txt_idbrg=<?php echo $data['kd_barang']; ?>">Detail</a></td>
