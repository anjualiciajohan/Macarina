<?php
   ...
   // $id_alamat = $_GET['idAll'];
    ...
    $add_to_alal ="DELETE FROM alamat_kirim WHERE id_reseller = '$user_id' ";
    $add_to_alal_result=mysqli_query($koneksi,$add_to_alal) or die(mysqli_error($koneksi));
