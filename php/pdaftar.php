<?php
   ...
   mysqli_query($koneksi, "insert into reseller (id_reseller, nama_reseller, alamat, no_tlp, scan_ktp, no_ktp, email, password, status, pas_foto) VALUES ('','$nama','$alamat ','$no_tlp','$fileName','$no_ktp ','$email  ','$pass  ','$status ','$fileName2')");
